...
class Sumber_dana extends CI_Controller {
	...
	{
		$data['lihat'] = $this->M_sumber_dana->lihat();
		$this->load->view('tambah/tambah_sumber_dana',$data);
	}

	public function tambah()
	{
		$cek= $this->M_sumber_dana->tambah();
		
		if($cek){
			$data="document.getElementById('berhasil').click();";
			$this->session->set_flashdata('pesan', 'onload="'.$data.'"');
			redirect('sumber_dana');
		}else{
	...
	{
		 $id=$_GET ['id'];
		$data['lihat'] = $this->M_sumber_dana->lihat_sumber_dana($id);
		$this->load->view('edit/edit_sumber_dana',$data);
	}

	public function proses_edit_sumber()
	{     
		$id=$_GET ['id'];
		$cek= $this->M_sumber_dana->edit($id);
	...
	public function proses_hapus_sumber($id)
	{     
		$id=$_GET ['id'];
		$cek= $this->M_sumber_dana->proses_hapus_sumber($id);
