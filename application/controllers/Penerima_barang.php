...
class Penerima_barang extends CI_Controller {
	...
	public function index()
	{
		...
		$data['select_data_detail_penerimabarang'] = $this->M_detail_penerima_barang->lihat();
		$this->load->view('tambah/tambah_penerima_barang',$data);
	}
	public function tambah()
	{
		$cek= $this->M_penerima_barang->tambah();

		if($cek){
			$data="document.getElementById('berhasil').click();";
			$this->session->set_flashdata('pesan', 'onload="'.$data.'"');
			redirect('penerima_barang');
		}else{
	...
	public function edit_penerima_barang()
	{
		 $id=$_GET ['id'];
		$data['lihat'] = $this->M_penerima_barang->lihat_penerima($id);
		$data['select_jenis_penerima'] = $this->M_jenis_penerima->lihat();
		$this->load->view('edit/edit_penerima_barang',$data);
	}

	public function proses_edit_penerima()
	{
		$id=$_GET ['id'];
	...
	public function proses_hapus_penerima($id)
	{
		$id=$_GET ['id'];
		$cek= $this->M_penerima_barang->proses_hapus_penerima($id);
