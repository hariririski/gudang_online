...
<head>
  ...
  <title>Data Pengambilan Barang</title>
           ...
           <?php
            ...
            ?>
             <tr>
               ...
               <td width="10%"> <a href ="<?php echo site_url (); ?>pengambilan_perpenerima?id=<?php echo $data_penerima_barang->id_penerima_barang; ?>"  > <button type="sumbmit"  id="inputStylePrimary" name="colorChosen"class="btn btn-primary">lihat Pengambilan</button></a></td>
