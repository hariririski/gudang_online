           ...
           <?php
            ...
            ?>
             <tr>
               ...
               <td><?php echo $data->id_penerima_barang_keluar; ?></td>
               <td><?php echo $data->username; ?></td>

               <td width="10%"> <a href ="<?php echo site_url (); ?>tambah_pengambilan_barang?id=<?php echo $data->id_penerima_barang_keluar; ?>"   > <button type="sumbmit" class="btn btn-primary">lihat Barang</button></a></td>
