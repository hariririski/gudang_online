      ...
      <!-- Panel Basic -->
       <?php
                ...
                ?>
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="sumber_dana/proses_edit_sumber?id=<?php echo $data->id_sumber_dana?>"" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Sumber Dana: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_sumber?>" name="nama_sumber"  placeholder="Nama Sumber Dana" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
