     ...
     <div class="modal-header">
        ...
        <!-- Example Horizontal Form -->
            ...
            ?>
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="barang/proses_edit_barang?id=<?php echo $data->id_barang?>" method="POST">
                                        
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Kode Barang : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" value="<?php echo $data->id_barang?>" name="kode_barang"  placeholder="kode Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                         <input type="text" class="form-control" value="<?php echo $data->nama_barang?>" name="nama_barang"  placeholder="nama Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" value="<?php echo $data->merek?>" name="merek"  placeholder="merk" autocomplete="off" required="" autofocus="on">
                        </div>
                      </div>
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                         <input type="text" class="form-control" value="<?php echo $data->volume?>" name="volume"  placeholder="volume" autocomplete="off" required="" autofocus="on">
                        </div>
                      </div>
