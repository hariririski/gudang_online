...
<body class="site-navbar-small " <?php echo $this->session->flashdata('pesan')?> >
  ...
  <div class="modal-header">
      ...
      <?php
            ...
            ?>
                  <div class="example">
                    <form class="form-horizontal" action="jenis_penerima/proses_edit_jenis?id=<?php echo $data->id_jenis_penerima?>"" method="POST">
                     
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Jenis Penerima: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_jenis_penerima?>" name="nama_penerima"  placeholder="Nama Penerima Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
