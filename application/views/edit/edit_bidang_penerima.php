      ...
      <!-- Panel Basic -->
              <?php
                ...
                ?>
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="detail_penerima_barang/proses_edit_bidang_penerima?id=<?php echo $data->id_data_detail_penerima_barang?>" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Bidang Penerima : </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_data_detail_penerima_barang?>" name="nama_bidang_penerima"  placeholder="Nama Tipe Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
