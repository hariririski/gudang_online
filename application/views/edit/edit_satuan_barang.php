...
<body class="site-navbar-small " <?php echo $this->session->flashdata('pesan')?> >
  ...
  <div class="modal-header">
      ...
      <!-- Panel Basic -->
            ...
            ?>
                  <div class="example">
                   <form class="form-horizontal" action="satuan_barang/proses_edit_satuan?id=<?php echo $data->id_satuan_barang?>" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Satuan Barang : </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_satuan?>" name="nama_satuan_barang"  placeholder="Nama Satuan Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
