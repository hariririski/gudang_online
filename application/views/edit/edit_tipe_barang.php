      ...
      <!-- Panel Basic -->
              <?php
                ...
                ?>
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="tipe_barang/proses_edit_tipe?id=<?php echo $data->id_tipe_barang?>" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Tipe Barang : </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_tipe?>" name="nama_tipe_barang"  placeholder="Nama Tipe Barang" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
