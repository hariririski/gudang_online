  ...
  <div class="modal-header">
      ...
      <!-- Panel Basic -->
           <?php
            ...
            ?>
                  <div class="example">
                   <form class="form-horizontal" action="tipe_faktur/proses_edit_tifak?id=<?php echo $data->id_tipe_faktur?>" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Tipe Faktur: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama_faktur?>" name="nama_faktur"  placeholder="Nama Tipe Faktur" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
