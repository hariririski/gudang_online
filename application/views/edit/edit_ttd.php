  ...
  <div class="modal-header">
      ...
      <!-- Panel Basic -->
           <?php
            ...
            ?>
                  <div class="example">
                   <form class="form-horizontal" action="ttd/proses_edit_ttd?id=<?php echo $data->id_ttd?>" method="POST">
                    
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Lengkap: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nama?>" name="nama"  placeholder="Nama" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
                       <div class="form-group" >
                        <label class="col-sm-2 control-label">Nip: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->nip?>" name="nip"  placeholder="Nip" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
                     <div class="form-group" >
                        <label class="col-sm-2 control-label">Jabatan: </label>
                        <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data->jabatan?>" name="jabatan"  placeholder="jabatan" autocomplete="off" required="" autofocus="on">
                      </div>
                      </div>
