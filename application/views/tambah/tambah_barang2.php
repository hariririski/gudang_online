...
<?php echo $this->load->view('share/menu', '', TRUE);?>
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
      <?php
         $i=0;
         $id_fakur=$_GET['id_faktur'];
         foreach($data_barang as $data){
         $i++;
       ?>
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Stok <?php echo $data->nama_barang?></h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="barang/proses_tambah_stok_barang?id_faktur=<?php echo $id_fakur?>&&id=<?php echo $data->id_barang; ?>" method="POST">
                        ...
                        <div class="col-sm-6 col-md-6">
                          <div class="form-group ">
                            ...
                            <div class="col-sm-4">
                              <input type="number" class="form-control" name="jumlah" placeholder="jumlah Barang" autocomplete="off" required="" autofocus="on">
                            </div>
                            <div class="col-sm-4">
                          ...
                          <div class="form-group ">
                            <label class="col-sm-4 control-label">Satuan Harga </label>
                            <div class="col-sm-8">
                              <input type="number" class="form-control" name="satuan" placeholder="satuan Harga" autocomplete="off" required="">
                            </div>
                          </div>
                          <div class="form-group">
