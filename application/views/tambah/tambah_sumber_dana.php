  ...
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Sumber dana</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="Sumber_dana/tambah" method="POST">
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Sumber Dana : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama_sumber" placeholder="APBA, APBD dll" autocomplete="off"  required="" autofocus="on">
                        </div>
                      </div>
     ...
     <div class="panel-body">
       <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
         ...
         <tbody>
           <?php
              $i=0;
              foreach($lihat as $data_sumber_dana){
              $i++;
            ?>
             <tr>
               <td><?php echo $i; ?></td>
               <td><?php echo $data_sumber_dana->nama_sumber; ?></td>
             <td width="10%"> <a href ="<?php echo site_url (); ?>edit_sumber_dana?id=<?php echo $data_sumber_dana->id_sumber_dana; ?>"  data-target="#exampleModalPrimary"
                        data-toggle="modal"  > <button type="sumbmit"  id="inputStylePrimary" name="colorChosen"class="btn btn-primary">Edit</button></a></td>
               <?php
               $super_admin=$this->session->userdata('super_admin');
               if ($super_admin==true){

               echo"<td class='center' width='10%'><a href='". site_url()."Sumber_dana/proses_hapus_sumber/?id=$data_sumber_dana->id_sumber_dana' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
