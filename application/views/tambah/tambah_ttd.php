  ...
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Ttd</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="ttd/proses_tambah_ttd" method="POST">
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Lengkap : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap" autocomplete="off" required="on" autofocus="on">
                        </div>
                      </div>
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nip" placeholder="Nip" autocomplete="off" required="">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="jabatan" placeholder="Jabatan" autocomplete="off" required="">
                        </div>
                      </div>
                      <div class="form-group">
     ...
     <header class="panel-heading">
       ...
       <h3 class="panel-title">Data Ttd</h3>
     </header>
     <div class="panel-body">
           ...
           <?php
            ...
            ?>
               <tr>
                ...
                <?php
                 echo"<td class='center' width='10%'><a href='". site_url()."ttd/hidupkan?id=$data->id_ttd' onclick=\"return confirm('Apakah Anda Yakin Mengaktifkan pengguna ?')
                ...
                echo"<td class='center' width='10%'><button type='button' class='btn btn-success'>Aktif</button>
                   </td>";
                 ...
                 <?php
                  ...
                  ?> 
                   ...
                   <td width="10%"> <a href ="<?php echo site_url (); ?>edit_ttd?id=<?php echo $data->id_ttd; ?>"  data-target="#exampleModalPrimary"
               ...
               echo"<td class='center' width='10%'><a href='". site_url()."ttd/proses_hapus_ttd/?id=$data->id_ttd' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
