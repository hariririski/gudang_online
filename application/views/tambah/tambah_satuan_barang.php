    ...
    <div class="panel panel-bordered">
              ...
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="satuan_barang/tambah" method="POST">
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Satuan Barang : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="satuan_barang" autofocus="on" placeholder="Lusi, kotak dll" autocomplete="off" required="">
                        </div>
                      </div>
     ...
     <div class="panel-body">
       <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
         ...
         <tbody>
           <?php
              $i=0;
              foreach($lihat as $data_satuan_barang){
              $i++;
            ?>
             <tr>
               <td><?php echo $i; ?></td>
               <td><?php echo $data_satuan_barang->nama_satuan; ?></td>
               <td width="10%"> <a href ="<?php echo site_url (); ?>edit_satuan_barang?id=<?php echo $data_satuan_barang->id_satuan_barang; ?>"  data-target="#exampleModalPrimary"
               ...
               echo"<td class='center' width='10%'><a href='". site_url()."satuan_barang/proses_hapus_satuan/?id=$data_satuan_barang->id_satuan_barang' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
