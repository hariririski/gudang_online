  ...
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Tipe Barang</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="tipe_barang/tambah" method="POST">
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Tipe Barang : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama_tipe_barang" placeholder="Nama Tipe Barang" autocomplete="off" required="" autofocus="on">
                        </div>
                      </div>
     ...
     <header class="panel-heading">
       ...
       <h3 class="panel-title">Data Tipe Barang</h3>
     </header>
     <div class="panel-body">
       <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
         ...
         <tbody>
           <?php
              $i=0;
              foreach($lihat as $data_tipe_barang){
              $i++;
            ?>
             <tr>
               <td><?php echo $i; ?></td>
               <td><?php echo $data_tipe_barang->nama_tipe; ?></td>
               <td width="10%"> <a href ="<?php echo site_url (); ?>edit_tipe_barang?id=<?php echo $data_tipe_barang->id_tipe_barang; ?>"  data-target="#exampleModalPrimary"
                        data-toggle="modal"  > <button type="sumbmit"  id="inputStylePrimary" name="colorChosen"class="btn btn-primary">Edit</button></a></td>
               <?php
               $super_admin=$this->session->userdata('super_admin');
               if ($super_admin==true){

               echo"<td class='center' width='10%'><a href='". site_url()."tipe_barang/proses_hapus_tipe/?id=$data_tipe_barang->id_tipe_barang' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
