  ...
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Penerima Barang</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="penerima_barang/tambah" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <select class="form-control" required name="jenis_penerima">
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama_penerima" autofocus="on" placeholder="Nama Lengkap" autocomplete="off" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 control-label">detail..... :</label>
                        <div class="col-sm-9">
                          <select class="form-control" required name="detail_penerima_barang">
                            <option value="">Pilih Jenis Penerima</option>
                            <?php
                               $i=0;
                               foreach($select_data_detail_penerimabarang as $select){
                               $i++;
                             ?>
     ...
     <header class="panel-heading">
       ...
       <h3 class="panel-title">Data Penerima Barang</h3>
     </header>
     <div class="panel-body">
       <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
         ...
         <tbody>
           <?php
              $i=0;
              foreach($lihat as $data_penerima_barang){
              $i++;
            ?>
             <tr>
               <td><?php echo $i; ?></td>
               <td><?php echo $data_penerima_barang->nama_jenis_penerima; ?></td>
               <td><?php echo $data_penerima_barang->nama_penerima; ?></td>
               <td><?php echo $data_penerima_barang->nama_data_detail_penerima_barang; ?></td>

               <td width="10%"> <a href ="<?php echo site_url (); ?>edit_penerima_barang?id=<?php echo $data_penerima_barang->id_penerima_barang; ?>"  data-target="#exampleModalPrimary"
                        data-toggle="modal"  > <button type="sumbmit"  id="inputStylePrimary" name="colorChosen"class="btn btn-primary">Edit</button></a></td>
                <?php
               $super_admin=$this->session->userdata('super_admin');
               if ($super_admin==true){

               echo"<td class='center' width='10%'><a href='". site_url()."penerima_barang/proses_hapus_penerima/?id=$data_penerima_barang->id_penerima_barang' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
