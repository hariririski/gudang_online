  ...
  <div class="page animsition">
    ...
    <div class="panel panel-bordered">
              <div class="panel-heading">
                <h3 class="panel-title">Tambah Jenis Penerima</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="example-wrap">
                  ...
                  <div class="example">
                    <form class="form-horizontal" action="jenis_penerima/tambah" method="POST">
                      <div class="form-group" >
                        <label class="col-sm-2 control-label">Nama Jenis Penerima : </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="nama_jenis_penerima" autofocus="on" placeholder="Fakultas, Prodi, Lab, Umum dll" autocomplete="off" required="">
                        </div>
                      </div>
     ...
     <header class="panel-heading">
       ...
       <h3 class="panel-title">Data jenis Penerima</h3>
     </header>
     <div class="panel-body">
       <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
         ...
         <tbody>
           <?php
              $i=0;
              foreach($lihat as $data_jenis_penerima){
              $i++;
            ?>
             <tr>
               <td><?php echo $i; ?></td>
               <td><?php echo $data_jenis_penerima->nama_jenis_penerima; ?></td>
               <td width="10%"> <a href ="<?php echo site_url (); ?>edit_jenis_penerima?id=<?php echo $data_jenis_penerima->id_jenis_penerima; ?>"   data-target="#exampleModalPrimary" data-toggle="modal"  > <button type="sumbmit"  id="inputStylePrimary" name="colorChosen"class="btn btn-primary">Edit</button></a></td>
               <?php
               $super_admin=$this->session->userdata('super_admin');
               if ($super_admin==true){

               echo"<td class='center' width='10%'><a href='". site_url()."jenis_penerima/proses_hapus_jenis/?id=$data_jenis_penerima->id_jenis_penerima' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
